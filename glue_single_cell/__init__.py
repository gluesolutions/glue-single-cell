def setup():
    ...
    from .menubar_plugin import ucsc_genome_plugin # noqa
    from .qtl_viewer.viewer import QTLViewer # noqa
    from .qtl_viewer.qt.qtl_subset_tool import QTLSubsetTool #noqa
    ...
    d3_dozen = ['#1E77B3','#FF7E0F','#2BA02A','#D62628',
                  '#9367BC','#8C564B','#E277C1','#7E7E7E',
                  '#BCBC21','#17BDCF','#3A0182','#004201',]
    d3_twenty = ['#1E77B3','#FF7E0F','#2BA02A','#D62628',
                  '#9367BC','#8C564B','#E277C1','#7E7E7E',
                  '#BCBC21','#17BDCF','#3A0182','#004201',
                  '#0DFFA8','#5D003F','#BCBCFF','#D8AFA1',
                  '#B80080','#004D52','#6B6400','#7C0100','#6027FE']
